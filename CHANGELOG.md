...
## [Unreleased]
### Fixed
- Fix SortingEventSubscriber double-prefixing with table-qualified columns

## [0.10.1] - 2026-06-02

### Fixed
- Revert: Table name prefix in order columns

## [0.10.0] - 2026-06-01

### Added
- int (unix timestamp) column support in SoftDeleteBehavior
- Closure value in SoftDeleteBehavior for fresh-per-delete resolution
...
[Unreleased]: https://github.com/efabrica-team/nette-database-repository/compare/0.10.1...main
[0.10.1]: https://github.com/efabrica-team/nette-database-repository/compare/0.10.0...0.10.1
[0.10.0]: https://github.com/efabrica-team/nette-database-repository/compare/0.9.0...0.10.0
[0.9.0]: https://github.com/efabrica-team/nette-database-repository/compare/0.8.0...0.9.0
