...
abstract class Repository
{
    ...
    public function update($record, iterable $data): ?ActiveRow
    {
        ...
        try {
            ...
            $this->callMethods(HookType::AFTER_UPDATE, ['oldRecord' => $oldModel, 'newRecord' => $recordToUpdate, 'data' => $data], $this->hookIgnores);
    ...
    public function delete($record): bool
    {
        ...
        try {
            ...
            $this->callMethods(HookType::BEFORE_DELETE, ['record' => $recordToDelete], $this->hookIgnores);
            $result = $recordToDelete->originalDelete($hookIgnores);
            $this->callMethods(HookType::AFTER_DELETE, ['record' => $oldRecord], $this->hookIgnores);
